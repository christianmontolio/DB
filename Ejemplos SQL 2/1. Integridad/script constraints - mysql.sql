...
values(2,1,0,1)
;
alter table cuenta drop  foreign key fk_cuenta_cliente
;
alter table cliente drop index idx_cliente
;
 alter table cuenta drop check ck_cuenta_estado
 ;
/* TODO:Verificar que los check no estan trabajando correctamente */
